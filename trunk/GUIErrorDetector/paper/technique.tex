...
in the UI thread. Nodes \CodeIn{uiAcc1}, \CodeIn{uiAcc2}, and \CodeIn{uiAcc3} are
UI-accessing methods. Node \CodeIn{start} is a (non-UI)
thread-spawning method, and
node \CodeIn{safe} is a safe UI Method. Methods \CodeIn{uiAcc1}
