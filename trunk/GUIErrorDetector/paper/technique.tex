...
the error detection algorithm. Finally, we present how to 
...
\CodeIn{Widget.checkWidget} and \CodeIn{Display.checkDevice},
...
library calls, users are also permitted to explicitly annotate project-specific methods
