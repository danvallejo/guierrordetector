...
Our tool
can find this error and generate a report as shown in
...
an unacceptable number of invalid warnings. %false positives and redundant warnings.
...
%, and produced significantly less
