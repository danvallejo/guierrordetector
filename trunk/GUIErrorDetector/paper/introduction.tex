...
to the same error. To address such limitations, we devise a set
 of sound and heuristic filters to remove likely false positives and redundant warnings.
...
We evaluated our implementation on \subnum programs comprising over \totaloc LOC.
...
from 4 different frameworks, comprising over \totaloc LOC. The results
