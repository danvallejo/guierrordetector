...
terminate the application, but it is considered \textbf{hard-to-recognize? probabably?} to nondeterministic concurrency errors.
...
\end{alltt}
\end{CodeOut}
\vspace*{-2.0ex} \Caption{{\label{fig:androiderror} 
Bug 703256 reported on 11/17/2011 in Mozilla Firefox release 10.0.a.rc3
for Android. On line 74, \CodeIn{LayerView}'s constructor
...
\vspace*{-2.0ex} \Caption{{\label{fig:report} Our tool reports
...
\item \textbf{Evaluation.} We applied our tool to 9 programs 
from 4 different frameworks, comprising over 76000 LOC. The results
