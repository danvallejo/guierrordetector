...
We evaluate our implementation on 10 subjects from four different
frameworks over 75000 LOC. The experiment results demonstrate
that: our technique is effective (it found 12 real-world errors
...
\item \textbf{Evaluation.} We performed an experiment on 10 subjects
from 4 different platforms over 75000 LOC to show the usefulness
