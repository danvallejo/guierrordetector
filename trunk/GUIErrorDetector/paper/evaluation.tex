...
annotations for it. 
During experiment, we found two subjects (MyTracks and Fennec)
use a customized pattern to interact with the GUI framework.
For them, we added \filternum user-defined filters.
...
by either searching the bug repository to check bug-fixing revision histories,
