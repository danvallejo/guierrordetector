...
when the JVM fails to launch the mail composing window of the
user default mail client (after a user clicks "eMail Me" button).
...
removed 65.52\% of the warnings. Among them, the 4th filter for removing
