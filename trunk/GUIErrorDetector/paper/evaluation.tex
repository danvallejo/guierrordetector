...
heuristic filters (Section~\ref{sec:heuristic}). Column ``\#Warning $F_i$''
represents the number of remaining warnings after applying
filters 1 -- $i$, and the number of last column is taken
from Table~\ref{table:results} (Subcolumn ``\#Warning'' under column ``1-CFA / with taming reflection'').} }
\end{table}
