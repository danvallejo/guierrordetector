...
criteria. First, the subject must be a multithreaded GUI application, not
...
subjects include end-user applications, programming tools, and games. 
...
underlying operating systems. Thus, we manually added 3 \CodeIn{@CalledByNativeMethods}
