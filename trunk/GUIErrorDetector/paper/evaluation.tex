...
\begin{figure}[t]
  ...
  \vspace*{-3.0ex}\caption {{\label{fig:ex} (a) shows an example code, in which
...
precise call graph built by 1-CFA. Nodes for constructors and \CodeIn{Thread.run()}
are omitted for brevity. Using the less precise call graph, the error
