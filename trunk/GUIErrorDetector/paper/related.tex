...
test generation~\cite{YuanCohenMemonTSE2011, YuanMemonICSE2007},
...
need a large number of test inputs that require substantile human effort.
...
Sundaresan et al.~\cite{Sundaresan:2000} went beyond the tranditional
CHA and RTA~\cite{rta} approaches in Java and and used type propagation
...
To enable call graph conostruction in the presence of  reflection,
...
Perphas the most close work to our reflection-aware call graph
...
In constrast, our algorithm leverages the powerful \textit{Bypass logic}
