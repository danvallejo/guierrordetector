...
reachability problem. Our technique starts from call graph entry nodes to
statically explore all possible paths that may cause a non-UI thread
to access a GUI object.
However, the heavy use of reflection in modern GUI applications makes existing
call graph construction algorithms insufficient to build a both complete and precise
call graph. Thus, we present a combined RTA and k-CFA
...
on XX subjects over XXX LOC, our technique found a number of real-world errors,
