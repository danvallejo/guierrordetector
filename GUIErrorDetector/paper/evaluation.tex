...
accounts as its backup repository. ArecaBackup~\cite{areca} offers a personal
...
\hline
\hline
 Total & 199161 / 199724 &  189 / 252 & 7 / 7 & 149441 / 153054& 138 / 138& 8 / 8 & 577821 / 652756& 22 / 22 & 11 / 12 & 6542\\
\hline
\end{tabular}
\end{center}
\vspace{-15pt}
...
Table~\ref{table:results} tabulates the experimental results.
Our tool found real errors in each subject programs.
...
%the 1-CFA algorithm found most errors (\bugs in total) and least
%false positive warnings (\falses in total). 

%We further examined the detailed results for each subject.
Among the \warnings warnings issued when using the 1-CFA call graph algorithm, \bugs
warnings reveal \bugs distinct errors (\newbugs are previously unknown),
...
We have submitted all of the newly-found errors
...
program. This error only happens when the \CodeIn{deleteCurrentBucket}
...
Besides the above two examples, other errors our tool reported were also
...
or redundant warnings. Specifically, two sound filters 1 and 2 identified
removed 36.52\% of the warnings, and three heuristic filters 3, 4, and 5
removed 63.44\% of the warnings. Among them, the 1st filter for removing
lexically redundant reports is the most effective one. 
...
\multicolumn{7}{|l|}{SWT desktop applications}   \\
 ...
 \hline
 FileBunker &  4494 &  4494 &  3210 &  3210 &  10  & 2\\
 \hline
...
\hline
 \hline
 Total &  60631 &  40461 &  38484 &  37425 &  112 & 22 \\
 \hline
\end{tabular}
\end{center}
\vspace{-15pt}
\Caption{{\label{table:filters}Number of warnings after applying a set of
sound and heuristic filters. Column ``Before Filtering''
...
The numbers in the last column are the same as the subcolumn ``\#Warnings"
