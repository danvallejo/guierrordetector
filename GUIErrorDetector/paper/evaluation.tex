...
writing a test driver to reproduce
the error,
or submitting a new bug report.
...
every node, but do not traverse every \emph{path} path to visit that node.
...
to the graph search strategy, and it never reports cyclic paths.  It may
