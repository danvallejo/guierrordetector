...
The subjects used in our experiment (Figure~\ref{table:subjects})
...
As shown in Figure~\ref{table:results}, our tool found
...
used in our experiments. As shown in Figure~\ref{table:results},  1-CFA found
...
The results in Figure~\ref{table:results} also show that using the
...
on average, but did not output any potential errors before it terminated.
...
under column ``1-CFA'' in Figure~\ref{table:results}.
} } \vspace{-2mm}
\end{figure}
...
Figure~\ref{table:filters} measures the effectiveness of the
