...
For all \subnum programs, we manually determined validity of each output warning
...
call graph construction algorithm (with \annotationnum native method annotations
...
2 errors in FileBunker and ArecaBackup had not yet been verified by developers.
...
do not provide any run-time checks for invalid thread accesses. The Swing
...
annotations (Section~\ref{sec:annotation}). The error in Fennec
