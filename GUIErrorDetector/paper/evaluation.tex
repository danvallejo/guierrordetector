...
a straightfoward approach (Section~\ref{sec:straightforward}),  compare the reflection-aware call graph
...
and manually added 3 \CodeIn{@CalledByNativeMethods}
...
warnings reveals 11 distinct errors, in which 6 are previously-unknwon.
...
acutally have the same error cause and are redundant with one another.
