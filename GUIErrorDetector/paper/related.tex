...
test inputs requiring substantile human effort, and then makes
testing fail to detect many potential errors.
...
our technique is a general one that can be easily tailored for
...
as large as those used in our experiments (including the dependent library code). Compared with model checking, the static analysis
