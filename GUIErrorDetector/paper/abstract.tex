...
call graph construction algorithms fail to build a good
call graph. Thus, we present a method to overcome the limitations, and
build reflection-aware call graphs.
...
Android. In an evaluation on 9 subjects over 75000 LOC, our technique
