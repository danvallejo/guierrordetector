...
and \CodeIn{Display.} \CodeIn{checkDevice} methods. SWT performs
...
\CodeIn{SwingUtilities.}\CodeIn{invokeLater} and \CodeIn{Swing-\\Utilities.invokeAndWait}, which execute code on the UI thread.
