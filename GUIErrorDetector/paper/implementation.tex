...
\CodeIn{SwingUtilities.}\CodeIn{invokeLater} and \CodeIn{Swing\-Util\-ities.invokeAndWait}, which execute code in the UI thread.
...
and \CodeIn{View.postDelay}, which execute code in the UI thread. 
